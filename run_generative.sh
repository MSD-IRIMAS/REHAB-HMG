...
TRAIN_VAE_SCRIPT="train_ascvae.py"
# TRAIN_LABEL_VAE_SCRIPT="train_acvae.py"
...
#     python3 $TRAIN_VAE_SCRIPT --generative-model SCVAE --class_index $class_index  > $log_file 2>&1
# done
...
# python3 $TRAIN_LABEL_VAE_SCRIPT --generative-model ACVAE  > $log_file 2>&1
