...
if __name__ == "__main__":
    ...
    label_output_directory_weights_losses = output_directory_gen_models + 'Action_conditioned' + '/ACVAE/'+ 'Wrec_' + str(args.wrec) + '_Wkl_' + str(args.wkl) + '/'
    ...
    for run in range(args.runs):
        for class_index in range(args.class_index):
                        ...
                        score_output_directory_run = score_output_directory_weights_losses + 'run_' + str(run) + '/'
                        ...
                        label_output_directory_run = label_output_directory_weights_losses + 'run_' + str(run) + '/'
                        ...
                        generator= ACVAE(output_directory=label_output_directory_run, device=args.device,epochs=2000)
                        generator= ACVAE(output_directory=label_output_directory_run, device=args.device,epochs=2000)
                        ...
                        if args.regression_models == 'STGCN':
                                ...
                                stgcn_run_dir_class = stgcn_directory + 'run_' + str(run) +'/class_'+str(class_index)
        ...
        #########################################################################################################################################################################""
                                ...
                                reg_run_dir_class = regressor_directory + 'run_' + str(run) +'/class_'+str(class_index)
